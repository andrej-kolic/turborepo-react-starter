...
const config = {
    ...
    // cacheDirectory: "/private/var/folders/sv/02zj1yy503l_hj6yyjn7qs_00000gn/T/jest_dx",
    ...
    // moduleNameMapper: {
    //   '\\.(jpg|jpeg|png|gif|eot|otf|webp|svg|ttf|woff|woff2|mp4|webm|wav|mp3|m4a|aac|oga)$': '<rootDir>/test/mockResource.ts',
    //   '\\.(css|scss)$': '<rootDir>/test/mockResource.ts',
    // },
    moduleNameMapper: {
      '^~ui/(.*)$': '<rootDir>/src/$1', // TODO: read from tsconfig
      '\\.(jpg|jpeg|png|gif|eot|otf|webp|svg|ttf|woff|woff2|mp4|webm|wav|mp3|m4a|aac|oga)$': '<rootDir>/test/mock-resource.ts',
